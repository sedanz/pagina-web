...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = '¡Yayyy! sabia siii jajaja';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').style.backgroundColor = '#FFBDBC';
        ...
        case 10:
            ...
            document.getElementById('noBtn').style.backgroundColor = '#FFBDBC';
            document.getElementById('sadGifContainer1').style.marginTop = '5%';
        ...
        case 11:
            ...
            document.getElementById('noBtn').style.backgroundColor = '#FFBDBC';
            document.getElementById('sadGifContainer1').style.marginTop = '10%';
        ...
        case 12:
            ...
            document.getElementById('noBtn').style.backgroundColor = '#FFBDBC';
            document.getElementById('sadGifContainer1').style.marginTop = '15%';
            // Hacer que el botón "Sí" crezca
        ...
        case 13:
            ...
            document.getElementById('noBtn').style.backgroundColor = '#FFBDBC';
            document.getElementById('sadGifContainer1').style.marginTop = '20%';
        ...
        case 14:
            ...
            document.getElementById('noBtn').style.backgroundColor = '#FFBDBC';
            document.getElementById('sadGifContainer1').style.marginTop = '25%';
            // Hacer que el botón "Sí" crezca
        ...
        case 15:
            ...
            document.getElementById('noBtn').style.backgroundColor = '#FFBDBC';
            document.getElementById('sadGifContainer1').style.marginTop = '30%';
            // Hacer que el botón "Sí" crezca
        ...
        case 16:
                ...
                document.getElementById('sadGifContainer3').style.marginTop = '35%';
                document.getElementById('happyGifContainer').style.display = 'none';
                // Vuelve al estado 0
                noButtonState = 0;
                break;
